...
contract AnonifyWithEnclaveKey is ReportHandle {
    ...
    event JoinGroup(uint32 rosterIdx, bytes16 _requestId);
    event StoreEnclaveKeyCiphertext(bytes ciphertext, uint256 stateCounter, bytes16 _requestId);
    ...
    function joinGroup(
        ...
        emit JoinGroup(_rosterIdx, _requestId);
    }
    ...
    function storeCommand(
        ...
        emit StoreEnclaveKeyCiphertext(_newCiphertext, incremented_state_counter, _requestId);
    }
}
